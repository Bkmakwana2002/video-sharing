...
const Detail = ({ postDetails }: Iprops) => {
  ...
  return (
    <div className='flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap'>
      <div className='relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-gray-400 bg-no-repeat bg-cover bg-center'>
        ...
        <div className='relative'>
          <div className='lg:h-[100vh] h-[60vh]'>
            <video ref={videRef} onClick={onVideClick} src={post.video.asset.url} className="h-full cursor-pointer" loop>

            </video>
          </div>
          <div className='absolute top-[45%] left-[40%]  cursor-pointer'>
            {!isPlaying && (
              <button onClick={onVideClick}>
